...
| | |
|---|---|
| [Primitives](examples/primitives.json) <br> <img src="examples/primitives.png" alt="Primitives example" width="40%"> | [Texturing](examples/textures.json) <br> <img src="examples/textures.png" alt="Texturing example" width="40%"> |
| [Obj model and Refraction](examples/obj.json) <br> <img src="examples/obj.png" alt="Texturing example" width="40%"> | [CSG](examples/csg.json) <br> <img src="examples/csg.png" alt="CSG example" width="40%"> |
